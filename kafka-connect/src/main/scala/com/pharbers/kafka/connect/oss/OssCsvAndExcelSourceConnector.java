 ...
 * @ClassName OssCsvAndExcelSourceConnector
 * @date 19-10-11 下午5:14
 * @Description: OssCsvAndExcelSourceConnector
 */
public class OssCsvAndExcelSourceConnector extends SourceConnector {
    ...
    public Class<? extends Task> taskClass() {
        return OssCsvAndExcelSourceTask.class;
    }
